...
export const projects: Project[] = [
  {
    ...
    date: "2024-10-15",
    challenge: "Build a scalable assignment management system with AI-powered plagiarism detection, multi-user role support, and real-time tracking for educational institutions.",
    solution:
  ...
  },
  {
    ...
    liveUrl: "",
    date: "2024-06-20",
    challenge: "Create a comprehensive CRM solution for a luxury fashion brand to streamline customer relationships, order management, and marketing campaigns.",
    solution:
  ...
  },
  {
    ...
    liveUrl: "",
    date: "2024-05-15",
    challenge: "Build a comprehensive complaint management system that provides transparency, real-time updates, and efficient resolution tracking for multiple user roles.",
    solution:
  ...
  },
  {
    ...
    date: "2025-01-10",
    challenge: "Create a visually appealing, fully responsive portfolio website that effectively showcases skills, projects, and achievements with optimal performance.",
    solution:
