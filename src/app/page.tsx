  ...
  const features = [
    {
      ...
      description: "Well-structured, maintainable, and scalable codebases.",
      gradient: "from-blue-500 to-cyan-500",
    },
    {
      icon: <Zap size={24} />,
      title: "High Performance",
      description: "Optimized applications with fast load times and SEO focus.",
      gradient: "from-purple-500 to-pink-500",
    },
    {
      icon: <Users size={24} />,
      title: "Team Collaboration",
      description: "Experience working with teams, APIs, and real-world workflows.",
      gradient: "from-orange-500 to-red-500",
    },
    {
      icon: <Sparkles size={24} />,
      title: "Modern AI Integration",
      description: "AI-powered features and automation using modern tools.",
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-x-hidden">
      ...
      <div className="relative z-10 container px-6 md:px-12 mx-auto">
        {/* ================= HERO SECTION ================= */}
        <section className="min-h-[100vh] lg:min-h-screen flex flex-col lg:flex-row items-center justify-center gap-12 pt-24 pb-12">
          <ScrollReveal direction="up" className="order-2 lg:order-1 w-full lg:w-1/2">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Full-stack engineer focused on building scalable, production-ready web applications.
                Specialized in modern frontend frameworks, backend APIs, databases, and cloud-ready
                architectures with a strong emphasis on performance and clean design.
              </p>
          ...
          >
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[450px] lg:h-[450px]">
              ...
              <div className="relative h-full w-full rounded-3xl overflow-hidden border-2 border-white/10 shadow-2xl">
                <Image
                  src={profileImageUrl}
                  alt="Vemuri Prince Tarun profile photo"
                  fill
        ...
        <section className="py-20">
          <div className="space-y-4 mb-12 text-center sm:text-left">
            ...
            <p className="text-muted-foreground">
              A selection of recent work demonstrating full-stack development expertise.
            </p>
          </div>
          ...
          <div className="relative p-8 sm:p-16 rounded-[2rem] bg-gradient-to-br from-blue-600 to-indigo-700 text-center text-white">
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-blue-100 max-w-md mx-auto">
                Looking for a developer who can design, build, and scale real-world applications?
              </p>
              <Link
                href="/contact"
