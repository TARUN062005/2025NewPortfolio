      ...
      <div className="relative z-10 container px-6 md:px-12 mx-auto">
          ...
          <ScrollReveal direction="up" className="order-2 lg:order-1 w-full lg:w-1/2">
            <div className="space-y-6 text-center lg:text-left">
              ...
              >
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-blue-500">Available for Hire</span>
              </motion.div>
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed">
                I'm <span className="text-foreground font-semibold">Tarun</span>. I build high-end web applications where performance meets beautiful design.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                <Link href="/projects" className="w-full sm:w-auto text-center px-8 py-4 bg-primary text-primary-foreground rounded-xl font-bold hover:scale-105 transition-transform">
                  View Projects
                </Link>
                <Link href="/contact" className="w-full sm:w-auto text-center px-8 py-4 bg-secondary/50 backdrop-blur-md border border-white/10 rounded-xl font-bold hover:bg-secondary transition-colors">
                  Contact Me
                </Link>
              </div>
            </div>
        ...
        <section className="py-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f, i) => (
              <motion.div
                key={i}
                whileTap={{ scale: 0.98 }} // Haptic feel for mobile
                className="p-6 rounded-2xl bg-secondary/20 border border-white/5 backdrop-blur-sm"
              >
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${f.gradient} flex items-center justify-center text-white mb-4`}>
                  {f.icon}
                </div>
        ...
        <section className="py-20">
          <div className="space-y-4 mb-12 text-center sm:text-left">
            ...
            <p className="text-muted-foreground">Handpicked work from my recent portfolio.</p>
          </div>
          ...
          <div className="mt-12 text-center">
            <Link href="/projects" className="inline-flex items-center gap-2 font-bold text-blue-500 hover:gap-3 transition-all">
        ...
        <section className="py-20 pb-32">
          <div className="relative p-8 sm:p-16 rounded-[2rem] bg-gradient-to-br from-blue-600 to-indigo-700 overflow-hidden text-center text-white">
            <div className="relative z-10 space-y-6">
              <h2 className="text-3xl sm:text-5xl font-black">Let's work together</h2>
              <p className="text-blue-100 max-w-md mx-auto">
                Ready to take your digital presence to the next level?
              </p>
              <Link href="/contact" className="inline-block px-10 py-4 bg-white text-blue-600 rounded-xl font-bold shadow-lg">
                Get Started
              </Link>
            </div>
          </div>
